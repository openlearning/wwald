...
public class UserThumbnailImageResource extends WebResource {
	...
	public IResourceStream getResourceStream() {
		return new IResourceStream() {
			...
			public InputStream getInputStream()
				...
				String userid = getParameters().getString("userid");
				if(userid == null) {
